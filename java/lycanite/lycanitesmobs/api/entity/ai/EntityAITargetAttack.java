...
public class EntityAITargetAttack extends EntityAITarget {
    ...
    **/
    ...
    protected boolean isValidTarget(EntityLivingBase target) {
        ...
        // Ownable Checks:
        if(this.host instanceof IEntityOwnable && StringUtils.isNotEmpty(((IEntityOwnable)this.host).func_152113_b())) {
            if(target instanceof IEntityOwnable && ((IEntityOwnable)this.host).func_152113_b().equals(((IEntityOwnable)target).func_152113_b()))
                return false;
